    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('cliente_queja', USER(), 'INSERT', JSON_OBJECT('new_cliente_id_cliente', NEW.CLIENTE_ID_CLIENTE, 'new_queja_id_queja', NEW.QUEJA_ID_QUEJA, 'new_dscr_queja', NEW.DSCR_QUEJA));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('cliente_queja', USER(), 'UPDATE', JSON_OBJECT('old_cliente_id_cliente', OLD.CLIENTE_ID_CLIENTE, 'new_cliente_id_cliente', NEW.CLIENTE_ID_CLIENTE, 'old_queja_id_queja', OLD.QUEJA_ID_QUEJA, 'new_queja_id_queja', NEW.QUEJA_ID_QUEJA, 'old_dscr_queja', OLD.DSCR_QUEJA, 'new_dscr_queja', NEW.DSCR_QUEJA));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('cliente_queja', USER(), 'DELETE', JSON_OBJECT('old_cliente_id_cliente', OLD.CLIENTE_ID_CLIENTE, 'old_queja_id_queja', OLD.QUEJA_ID_QUEJA, 'old_dscr_queja', OLD.DSCR_QUEJA));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('empleado', USER(), 'INSERT', JSON_OBJECT('new_id_empleado', NEW.ID_EMPLEADO, 'new_nom_empleado', NEW.NOM_EMPLEADO, 'new_cargo_empleado', NEW.CARGO_EMPLEADO, 'new_tel_empleado', NEW.TEL_EMPLEADO, 'new_dir_empleado', NEW.DIR_EMPLEADO, 'new_email_empleado', NEW.EMAIL_EMPLEADO));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('empleado', USER(), 'UPDATE', JSON_OBJECT('old_id_empleado', OLD.ID_EMPLEADO, 'new_id_empleado', NEW.ID_EMPLEADO, 'old_nom_empleado', OLD.NOM_EMPLEADO, 'new_nom_empleado', NEW.NOM_EMPLEADO, 'old_cargo_empleado', OLD.CARGO_EMPLEADO, 'new_cargo_empleado', NEW.CARGO_EMPLEADO, 'old_tel_empleado', OLD.TEL_EMPLEADO, 'new_tel_empleado', NEW.TEL_EMPLEADO, 'old_dir_empleado', OLD.DIR_EMPLEADO, 'new_dir_empleado', NEW.DIR_EMPLEADO, 'old_email_empleado', OLD.EMAIL_EMPLEADO, 'new_email_empleado', NEW.EMAIL_EMPLEADO));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('empleado', USER(), 'DELETE', JSON_OBJECT('old_id_empleado', OLD.ID_EMPLEADO, 'old_nom_empleado', OLD.NOM_EMPLEADO, 'old_cargo_empleado', OLD.CARGO_EMPLEADO, 'old_tel_empleado', OLD.TEL_EMPLEADO, 'old_dir_empleado', OLD.DIR_EMPLEADO, 'old_email_empleado', OLD.EMAIL_EMPLEADO));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('ingredientes', USER(), 'INSERT', JSON_OBJECT('new_id_ingredientes', NEW.ID_INGREDIENTES, 'new_compra_id_compra', NEW.COMPRA_ID_COMPRA, 'new_nom_ingrediente', NEW.NOM_INGREDIENTE, 'new_tipo_ingrediente', NEW.TIPO_INGREDIENTE));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('ingredientes', USER(), 'UPDATE', JSON_OBJECT('old_id_ingredientes', OLD.ID_INGREDIENTES, 'new_id_ingredientes', NEW.ID_INGREDIENTES, 'old_compra_id_compra', OLD.COMPRA_ID_COMPRA, 'new_compra_id_compra', NEW.COMPRA_ID_COMPRA, 'old_nom_ingrediente', OLD.NOM_INGREDIENTE, 'new_nom_ingrediente', NEW.NOM_INGREDIENTE, 'old_tipo_ingrediente', OLD.TIPO_INGREDIENTE, 'new_tipo_ingrediente', NEW.TIPO_INGREDIENTE));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('ingredientes', USER(), 'DELETE', JSON_OBJECT('old_id_ingredientes', OLD.ID_INGREDIENTES, 'old_compra_id_compra', OLD.COMPRA_ID_COMPRA, 'old_nom_ingrediente', OLD.NOM_INGREDIENTE, 'old_tipo_ingrediente', OLD.TIPO_INGREDIENTE));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('plato', USER(), 'INSERT', JSON_OBJECT('new_id_plato', NEW.ID_PLATO, 'new_categoria_id_categoria_plato', NEW.CATEGORIA_ID_CATEGORIA_PLATO, 'new_nombre_plato', NEW.NOMBRE_PLATO, 'new_descripcion_plato', NEW.DESCRIPCION_PLATO, 'new_precio_plato', NEW.PRECIO_PLATO));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('plato', USER(), 'UPDATE', JSON_OBJECT('old_id_plato', OLD.ID_PLATO, 'new_id_plato', NEW.ID_PLATO, 'old_categoria_id_categoria_plato', OLD.CATEGORIA_ID_CATEGORIA_PLATO, 'new_categoria_id_categoria_plato', NEW.CATEGORIA_ID_CATEGORIA_PLATO, 'old_nombre_plato', OLD.NOMBRE_PLATO, 'new_nombre_plato', NEW.NOMBRE_PLATO, 'old_descripcion_plato', OLD.DESCRIPCION_PLATO, 'new_descripcion_plato', NEW.DESCRIPCION_PLATO, 'old_precio_plato', OLD.PRECIO_PLATO, 'new_precio_plato', NEW.PRECIO_PLATO));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('plato', USER(), 'DELETE', JSON_OBJECT('old_id_plato', OLD.ID_PLATO, 'old_categoria_id_categoria_plato', OLD.CATEGORIA_ID_CATEGORIA_PLATO, 'old_nombre_plato', OLD.NOMBRE_PLATO, 'old_descripcion_plato', OLD.DESCRIPCION_PLATO, 'old_precio_plato', OLD.PRECIO_PLATO));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('proveedor', USER(), 'INSERT', JSON_OBJECT('new_id_proveedor', NEW.ID_PROVEEDOR, 'new_compra_id_compra', NEW.COMPRA_ID_COMPRA, 'new_nom_proveedor', NEW.NOM_PROVEEDOR, 'new_tel_proveedor', NEW.TEL_PROVEEDOR, 'new_dir_proveedor', NEW.DIR_PROVEEDOR));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('proveedor', USER(), 'UPDATE', JSON_OBJECT('old_id_proveedor', OLD.ID_PROVEEDOR, 'new_id_proveedor', NEW.ID_PROVEEDOR, 'old_compra_id_compra', OLD.COMPRA_ID_COMPRA, 'new_compra_id_compra', NEW.COMPRA_ID_COMPRA, 'old_nom_proveedor', OLD.NOM_PROVEEDOR, 'new_nom_proveedor', NEW.NOM_PROVEEDOR, 'old_tel_proveedor', OLD.TEL_PROVEEDOR, 'new_tel_proveedor', NEW.TEL_PROVEEDOR, 'old_dir_proveedor', OLD.DIR_PROVEEDOR, 'new_dir_proveedor', NEW.DIR_PROVEEDOR));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('proveedor', USER(), 'DELETE', JSON_OBJECT('old_id_proveedor', OLD.ID_PROVEEDOR, 'old_compra_id_compra', OLD.COMPRA_ID_COMPRA, 'old_nom_proveedor', OLD.NOM_PROVEEDOR, 'old_tel_proveedor', OLD.TEL_PROVEEDOR, 'old_dir_proveedor', OLD.DIR_PROVEEDOR));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('queja', USER(), 'INSERT', JSON_OBJECT('new_id_queja', NEW.ID_QUEJA, 'new_fecha_queja', NEW.FECHA_QUEJA));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('queja', USER(), 'UPDATE', JSON_OBJECT('old_id_queja', OLD.ID_QUEJA, 'new_id_queja', NEW.ID_QUEJA, 'old_fecha_queja', OLD.FECHA_QUEJA, 'new_fecha_queja', NEW.FECHA_QUEJA));
    END;
    ...
    BEGIN
        INSERT INTO auditoria (nombre_tabla, usuario_db, accion, descripcion_cambios)
        VALUES ('queja', USER(), 'DELETE', JSON_OBJECT('old_id_queja', OLD.ID_QUEJA, 'old_fecha_queja', OLD.FECHA_QUEJA));
    END;
